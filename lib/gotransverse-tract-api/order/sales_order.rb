  ...
  module Order
    ...
    class SalesOrder
      ...
      class << self
        ...
        # @param {String} query_scope (default: 'SHALLOW')
        #
        def find_by_purchase_order_num purchase_order_num, query_scope=nil
          GoTransverseTractApi.get_response_for(self, {purchase_order_num: purchase_order_num, queryScope: query_scope})
        end
