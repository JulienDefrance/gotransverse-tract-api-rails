  ...
  module GeneralLedger
    ...
    class GLAccountingEntry
      ...
      class << self
        ...
        # @param {Hash} options
        #
        def find_by_gl_accounting_transaction_eid gl_accounting_transaction_eid, options=nil
        ...
        # @param {Hash} options
        #
        def find_by_gl_transaction_batch_num gl_transaction_batch_num, options=nil
        ...
        # @param {Hash} options
        #
        def find_by_gl_aggregate_eid gl_aggregate_eid, options=nil
        ...
        # @param {Hash} options
        #
        def find_by_gl_aggregate_batch_num gl_aggregate_batch_num, options=nil
